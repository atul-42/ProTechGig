  ...
  return (
    <div className="selling">
      ...
      <div className="section">
        ...
        <p>Create an account on ProTechGig if you have not already.<br />
    ...
    <div className='section'>
        ...
        <p>Click on the Sell a Service or Create a Gig button.<br />
